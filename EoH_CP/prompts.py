...
class Prompts:
    ...
    def get_alg_imp_1(self, program_info_1, program_info_2):
        """Algorithm improvement prompt"""
        prompt = f"""
        I have 2 solution programs for an FSTSP problem as follows:
        code_1:
        {program_info_1['code']}
        code_2:
        {program_info_2['code']}
    ...
    def get_alg_imp_2(self, program_info_1, program_info_2):
        """Algorithm improvement prompt"""
        prompt = f"""
        I have 2 solution programs for an FSTSP problem as follows:
        code_1:
    ...
    def get_alg_imp_3(self,program_info):
        """Algorithm improvement prompt"""
        prompt = f"""
        I have a solution program for an FSTSP problem as follows:
        code:
        {program_info['code']}
        Please assist me in creating a new algorithm that has a different form but can be a modified version of the algorithm provided.
        The other parts of the program remain unchanged.
        Return in the form: {{"..."}}
        The part "..." must be a nature language description of new algorithm
        Do not make extra explanation.
        """
    ...
    def get_alg_imp_4(self, program_info):
        """Algorithm improvement prompt"""
        prompt = f"""
        I have a solution program for an FSTSP problem as follows:
        code:
        {program_info['code']}
        Please identify the main algorithm parameters and assist me in creating a new algorithm that has a different parameter settings of the functions in the code. 
        The other parts of the program remain unchanged.
        Return in the form: {{"..."}}
        The part "..." must be a nature language description of new algorithm
        Do not make extra explanation.
    ...
    def get_alg_imp_5(self, program_info):
        """Algorithm improvement prompt"""
        prompt = f"""
        I have a solution program for an FSTSP problem as follows:
        code:
        {program_info['code']}
        First, you need to identify the main components in the program.
        ...
        Finally, provide the revised code, keeping the functions in  name, inputs, and outputs unchanged.
        Return in the form: {{"..."}}
    ...
    def get_code_imp(self, prob_name, program_info):
        ...
        {program_info['code']}
        The above is a solution program for an {prob_name} problem. 
        an improved solving algorithm has been proposed: {program_info['new_algorithm']}.
        Improve the program by using the new algorithm to solve the problem, and provide the complete improved program.
