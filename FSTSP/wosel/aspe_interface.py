...
class ASPE_Interface:
    ...
    def generate_new_individual(self, program_info):
        ...
        try:
            ...
            random_element = random.choice(program_info['sub_prob_alg'])
            random_element_str = str(random_element)
            program_info.update(self.prompts.extract_sub_problem(random_element_str))
            ...
            response4 = self.prompts.get_alg_imp("FSTSP", program_info)
